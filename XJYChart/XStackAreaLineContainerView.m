...
- (CAShapeLayer *)getLineShapeLayerWithPoints:(NSArray<NSValue *> *)points leftConerPoint:(CGPoint)leftConerPoint rightConerPoint:(CGPoint)rightConerPoint color:(UIColor *)color {
    ...
    for(int i = 0; i < points.count - 1; i++) {
        ...
        if (self.lineMode == CurveLine) {
            CGPoint midPoint = [XStackAreaLineContainerView midPointBetweenPoint1:point1 andPoint2:point2];
            [line addQuadCurveToPoint:midPoint
                         controlPoint:[XStackAreaLineContainerView controlPointBetweenPoint1:midPoint andPoint2:point1]];
            [line addQuadCurveToPoint:point2
                         controlPoint:[XStackAreaLineContainerView controlPointBetweenPoint1:midPoint andPoint2:point2]];
        } else {
