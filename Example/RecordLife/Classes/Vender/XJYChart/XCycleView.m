...
#define mediumColor [UIColor colorWithRed:123 / 255.0 green:138 / 255.0 blue:146 / 255.0 alpha:1]
#define shallowColor  [UIColor colorWithRed:178 / 255.0 green:187 / 255.0 blue:192 / 255.0 alpha:1]
#define deepColor [UIColor colorWithRed:64 / 255.0 green:89 / 255.0 blue:100 / 255.0 alpha:1]
    ...
    self.progressLayer = [self
        cycleShapeLayerWithCenter:center
                       ...
                       startAngle:[self getStartAngleOfArc]
                         endAngle:[self getEndAngleOfArcWithProgress:self.progress]];
...
///cycle layer
- (CAShapeLayer *)cycleShapeLayerWithCenter:(CGPoint)center radius:(CGFloat)radius startAngle:(CGFloat)startAngle endAngle:(CGFloat)endAngle {
...
-(CGPoint)pointFromAngle:(int)angleInt{
    ...
    result.y = round(centerPoint.y + self.radius * sin(DEGREES_TO_RADIANS(angleInt+3))) ;
    result.x = round(centerPoint.x + self.radius * cos(DEGREES_TO_RADIANS(angleInt+3)));
    return result;
}
